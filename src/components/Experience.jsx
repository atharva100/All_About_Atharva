...
function Experience() {
  ...
  return (
    <div className="py-16" id="work" ref={experienceRef}>
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="flex flex-col space-y-12">
          {EXPERIENCES.map((exp, index) => (
            <div
              key={index}
              className="flex flex-col items-start justify-between md:flex-row experience-item  "
            >
              ...
              <div className="w-full md:w-3/4">
                ...
                <div className="flex flex-wrap gap-2">
                  {exp.techStack.map((tech, id) => (
                    <span
                      key={id}
                      className="rounded-full border-2 border-pink-500/30 px-3 py-1 font-semibold text-sm"
                    >
                      {tech}
                    </span>
                  ))}
